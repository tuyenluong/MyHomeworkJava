...
public class LotteryTicket {
    ...
    public static void main(String[] args){
        ...
        int [] ticket = gererateNumber();
        //Arrays.sort(ticket);
        printTicket(ticket);
    }

    public static int[] gererateNumber(){
    ...
    public static boolean search(int[] array, int numberToSearchFor){
         ...
         */
        for (int value : array){
            //Enhanced loop work best in  works best when you're
            //working with values that are already there.
            if(value == numberToSearchFor){
                return true;
            }
        }
        /*If we've reached this point,
        then the entire array was searched
